...
<aside class = "bg-[#F9F5F0] dark:bg-gray-800 w-64 flex-shrink-0 h-screen shadow-lg">
    <div class = "flex flex-col h-full">

        {{-- Header --}}
        <div class = "flex items-center justify-center h-16 border-b border-[#F2E8DE] dark:border-gray-700">
            <h2 class = "text-2xl font-bold text-[#2E6C6F]">Menú</h2>
        </div>
            ...
            <ul class = "space-y-1">
                ...
                <li>
                    <a href = "{{ route('AdminDashboard') }}"
                       class = "flex items-center px-4 py-3 rounded-lg bg-[#2E6C6F] text-white">
        ...
        <div class = "p-4 border-t border-[#F2E8DE] dark:border-gray-700">
            ...
            <a href = "{{ route('login') }}"
               class = "flex items-center px-4 py-3 rounded-lg text-gray-600 hover:bg-[#D89C83] hover:text-white">
                <svg class = "h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24"
                     stroke = "currentColor">
                    <path stroke-linecap = "round" stroke-linejoin="round" stroke-width="2"
